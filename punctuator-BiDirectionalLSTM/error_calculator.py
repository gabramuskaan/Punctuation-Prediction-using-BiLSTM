...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        target_path = r"C:\Users\Dell\OneDrive\Desktop\MAJOR\majorV3\punctuator2-BiDirectionalRNN\testPunced.txt"#sys.argv[1]
    # else:
    #     sys.exit("Ground truth file path argument missing")

    if len(sys.argv) > 2:
        predicted_path = r"C:\Users\Dell\OneDrive\Desktop\MAJOR\majorV3\punctuator2-BiDirectionalRNN\testPunced - Copy.txt"#sys.argv[2]
    # else:

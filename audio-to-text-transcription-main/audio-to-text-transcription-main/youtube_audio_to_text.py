...
output_path = r"C:\Users\Dell\OneDrive\Desktop\audio-to-text-transcription-main (1)\audio-to-text-transcription-main\YoutubeAudios"
filename = "audio.mp3"
...
result = model.transcribe(r"C:\Users\Dell\OneDrive\Desktop\audio-to-text-transcription-main (1)\audio-to-text-transcription-main\YoutubeAudios\audio.mp3")

...
f = open(r"C:\Users\Dell\OneDrive\Desktop\audio-to-text-transcription-main (1)\Course4.txt", "r")
video_urls = f.readlines()

# Output directory for audio & text files
download_directory = r"C:\Users\Dell\OneDrive\Desktop\audio-to-text-transcription-main (1)\audio-to-text-transcription-main\YoutubeAudios\Course4_dnld"
output_directory = r"C:\Users\Dell\OneDrive\Desktop\audio-to-text-transcription-main (1)\audio-to-text-transcription-main\YoutubeAudios\Transcribed_text4"
